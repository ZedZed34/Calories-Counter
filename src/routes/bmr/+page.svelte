<script>
  ...
  import { bmr } from '$lib/utils/calories';
  ...
  function handleCalculate(event) {
    ...
    if (!userData.sex || !userData.age || !userData.heightCm || !userData.weightKg) {
...
<svelte:head>
  <title>BMR Calculator (Metric)</title>
  <meta name="description" content="Calculate your Basal Metabolic Rate (Mifflin–St Jeor, metric)." />
</svelte:head>
...
<div class="shell">
  ...
  <main>
    ...
    {#if showResult}
      <p style="margin-top:.5rem">Your BMR: <strong>{bmrValue} kcal/day</strong></p>
    {:else}
      <div class="placeholder">
        <p>Click "Get Result" to calculate your Basal Metabolic Rate!</p>
      </div>
    {/if}
  </main>
</div>
